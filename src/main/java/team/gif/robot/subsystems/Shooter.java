...
public class Shooter extends SubsystemBase {
    ...
    private static final SparkMaxPIDController flywheelPIDController = flywheelMotor.getPIDController();
    private static final RelativeEncoder flywheelEncoder = flywheelMotor.getEncoder();
