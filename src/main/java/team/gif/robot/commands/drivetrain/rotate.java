...
public class rotate extends CommandBase {
    ...
    public void initialize() {
        ...
        initialHeadingDegrees = Robot.pigeon.get360Heading();
 ...
 */
        ...
        currentHeadingDegrees = Robot.pigeon.get360Heading();
        ...
        if(Math.abs(deltaDegrees) - degreesTurned<=90){
            Robot.drivetrain.tankDriveVolts(slowmotorVolts, -slowmotorVolts);
